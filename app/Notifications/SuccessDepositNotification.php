...
class SuccessDepositNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('Your Deposit Was Approved Successfully')
            ->greeting('Hello, '. $this->user->name . '.')
            ->line('Your deposit of ' . $this->deposit->amount . ' has been approved')
