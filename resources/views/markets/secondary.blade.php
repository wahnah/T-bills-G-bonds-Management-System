<x-app-layout>
                    ...
                    <div class="container mx-auto">
                        ...
                        <div class="grid lg:grid-cols-2 sm:grid-cols-2 gap-4">
                            <div class="flex flex-col justify-between m-5 p-3 rounded-md shadow-md">
                                ...
                                <a href="{{ route('markets.secondaryBonds') }}" class="card border-dark mb-3"
                            ...
                            <div class="flex flex-col justify-between m-5 p-3 rounded-md shadow-md">
                                ...
                                <a href="{{ route('markets.secondaryBills') }}" class="card border-dark mb-3"
                                    style="max-width: 18rem;">
                                    <div class="card-body text-dark">
    ...
    <a href="{{ route('markets.secondaryBonds') }}">
    ...
    <a href="{{ route('markets.secondaryBills') }}">
