    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class=" overflow-hidden ">
                    ...
                    <form class="flex flex-wrap" method="post" action="{{ route('lots.estimateBondPriceCalc', $lot->id) }}"
                        enctype="multipart/form-data">
                        @csrf
                        <label class="block mb-1 text-gray-600" for="noCoups">Enter number of coupons you recieved</label>
                        <input id="noCoups" name="noCoups"
